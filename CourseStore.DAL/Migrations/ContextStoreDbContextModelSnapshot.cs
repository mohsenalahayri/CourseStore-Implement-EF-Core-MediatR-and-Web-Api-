...
{
    [DbContext(typeof(ContextStoreDbContext))]
    partial class ContextStoreDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseStor.Model.Courses.Entities.CourseTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CourseStor.Model.Courses.Entities.CourseTag", b =>
                {
                    ...
                    b.HasOne("CourseStore.DAL.Entities.Tag", "Tag")
                        .WithMany("CourseTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CourseStore.DAL.Entities.CourseTeacher", b =>
                {
                    ...
                    b.HasOne("CourseStore.DAL.Entities.Teacher", "Teachers")
                        .WithMany("CourseTeachers")
